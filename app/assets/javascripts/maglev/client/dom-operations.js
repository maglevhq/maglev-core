...
const addSection = (event) => {
  ...
  void updatePreviewDocument({ layoutStoreId, sectionId, insertAt, scrollToSection: true }).catch((err) => {
...
const updatePreviewDocument = async ({ layoutStoreId, sectionId, insertAt = undefined, scrollToSection = false }) => {
  log('[DOM Operations] updatePreviewDocument', layoutStoreId, sectionId, insertAt, scrollToSection)
