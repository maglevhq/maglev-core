...
export default {
  ...
  computed: {
    ...
    hasEnoughWidthForTablet() {
      return this.isTabletDevice && this.previewPaneMaxWidth > this.deviceWidthMap.tablet
    },
    hasEnoughWidthForMobile() {
      return this.isMobileDevice && this.previewPaneMaxWidth > this.deviceWidthMap.mobile
    }
  },
  methods: {
