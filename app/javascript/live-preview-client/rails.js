...
const csrfParam = {
  [parentDocument.querySelector('meta[name=\'csrf-param\']').getAttribute('content')]: parentDocument.querySelector('meta[name=\'csrf-token\']').getAttribute('content')
}
...
const addSection = (event) => {
  ...
  console.log(content, section, insertAt)
...
const updatePreviewDocument = (content, section, insertAt) => {
  const attributes = {
  ...
  axios.post(previewDocument.location.href, { ...attributes, ...csrfParam }).then(({ data }) => {
