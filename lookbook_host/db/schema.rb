...
# Used by activerecord-nulldb-adapter: NullDB loads this file to define table/column
# metadata so Maglev ActiveRecord models can boot without a real database.
# Keep in sync with spec/dummy/db/schema.rb (minus DB-specific extensions).
#
# This is not applied to a real database in lookbook_host; no db:migrate required.
