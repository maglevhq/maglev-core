...
RSpec.describe Maglev::Editor::Combobox::CollectionItemsController, type: :request do
  ...
  describe 'GET #index' do
    it 'returns no items' do
      get '/maglev/editor/combobox/collection_items', as: :turbo_stream, params: { collection_id: 'products', query: 'random' }
  ...
  describe 'GET #index' do
    it 'returns the filtered items' do
      get '/maglev/editor/combobox/collection_items', as: :turbo_stream, params: {  collection_id: 'products', query: 'Product' }
      expect(response).to be_successful
