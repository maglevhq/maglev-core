...
describe Maglev::ApplicationHelper do
  let(:title) { nil }
  ...
  describe '#maglev_editor_title' do
    subject { helper.maglev_editor_title }
  ...
  describe '#maglev_primary_hex_color' do
    subject { helper.maglev_primary_hex_color }
  ...
  describe '#maglev_primary_rgb_color' do
    subject { helper.maglev_primary_rgb_color }
  ...
  describe '#maglev_editor_logo_url' do
    subject { helper.maglev_editor_logo_url }

    it 'returns the default logo url' do
      expect(helper).to receive(:asset_path).with('maglev/logo.svg')
      subject
    end
