...
ActiveRecord::Schema[8.0].define(version: 20_220_612_092_235) do
  ...
  create_table 'maglev_pages', charset: 'utf8mb4', collation: 'utf8mb4_unicode_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.text 'title_translations', size: :long, default: '{}', collation: 'utf8mb4_bin'
    t.text 'seo_title_translations', size: :long, default: '{}', collation: 'utf8mb4_bin'
    t.text 'meta_description_translations', size: :long, default: '{}', collation: 'utf8mb4_bin'
    t.text 'sections_translations', size: :long, default: '{}', collation: 'utf8mb4_bin'
    t.integer 'lock_version'
    t.text 'og_title_translations', size: :long, default: '{}', collation: 'utf8mb4_bin'
    t.text 'og_description_translations', size: :long, default: '{}', collation: 'utf8mb4_bin'
    t.text 'og_image_url_translations', size: :long, default: '{}', collation: 'utf8mb4_bin'
  ...
  create_table 'maglev_sites', charset: 'utf8mb4', collation: 'utf8mb4_unicode_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.text 'locales', size: :long, default: '[]', collation: 'utf8mb4_bin'
    t.text 'sections_translations', size: :long, default: '{}', collation: 'utf8mb4_bin'
    t.integer 'lock_version'
    t.text 'style', size: :long, default: '[]', collation: 'utf8mb4_bin'
